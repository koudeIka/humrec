...
{/** @class releases
  ...
  **/
	 ...
	 **/
		...
		{//-- Insert
			if(!$this->mysql->query("INSERT INTO releases (rel_number, rel_title, rel_date, rel_tracklist, rel_content_fr, rel_content_en, rel_download, rel_paypal_id, rel_paypal_priceue, rel_paypal_priceworld, rel_paypal_currency_code, rel_paypal_encrypted, rel_stream, rel_show, sublab_id)
